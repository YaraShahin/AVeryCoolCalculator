...
class Window(QMainWindow):
    ...
    def __init__(self):
        ...
        # setting title
        self.setWindowTitle("A Very Cool Calculator")

        # setting geometry setGeometry( Horizontal Position in px, Vertical Position in px, Horizontal Size, Vertical size )
        self.setGeometry(1300, 150, 360, 350)
    ...
    def UiComponents(self):
        ...
        push_clear.setGeometry(5, 100, 100, 40)

        # del one character button
        push_del = QPushButton("Del", self)
        push_del.setGeometry(210, 100, 145, 40)

        # adding a lol button to the screen
        # creating a push button
        lolpush = QPushButton("lol", self)

        # setting geometry
        lolpush.setGeometry(110, 100, 100, 40)

       # adding lol button a color effect
        c_effect = QGraphicsColorizeEffect()
        c_effect.setColor(Qt.yellow)
        lolpush.setGraphicsEffect(c_effect)
        ...
        lolpush.clicked.connect(self.action_lol)
